...
/// <summary>
/// An editor for <see cref="int"/> (32-bit signed integer) values. Parses integer input using invariant culture
/// and formats the value with an optional <see cref="BaseEditor{T}.FormatString"/>.
/// </summary>
public class IntEditor : BaseEditor<int>
{
    /// <summary>
    /// Attempts to parse <paramref name="text"/> as an <see cref="int"/> using invariant culture.
    /// </summary>
