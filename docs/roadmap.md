...
|--------------|-------------------------------------------------------------------------|--------|---------------------------|
| FEATURE-28E8 | Repository & solution scaffolding (root config, .slnx, project skeletons) | TODO   | docs/plan/FEATURE-28E8.md |
| - PHASE01    | Root configuration & solution file                                       | TODO   | (in FEATURE-28E8.md)      |
